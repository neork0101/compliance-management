package com.in.compliance.security;
...
import com.in.compliance.jwt.AuthEntryPointJwt;
import com.in.compliance.jwt.AuthTokenFilter;
...
//  }
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.csrf(csrf -> csrf.disable())
				...
				.authorizeHttpRequests(auth -> auth.requestMatchers("/compliancemanagement/api/auth/**").permitAll()
						.requestMatchers("/compliancemanagement/api/vmt/**").permitAll()
						.requestMatchers("/compliancemanagement/actuator/**").permitAll()
						.requestMatchers("/compliancemanagement/swagger-ui/**").permitAll().anyRequest()
						.authenticated());
