...
public class GatewaysSecurityManagement {

	private static final Logger LOG = LoggerFactory.getLogger(GatewaysSecurityManagement.class);
	
	@Autowired(required = true)
	RoleRepository roleRepo;
	
	public static void main(String[] args) {
		SpringApplication.run(GatewaysSecurityManagement	.class, args);
	}
